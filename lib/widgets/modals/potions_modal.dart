      ...
      return StatefulBuilder(
        builder: (context, setState) {
          Widget buildItemColumn(Map<String, dynamic> itemData) {
            ...
            final String name = itemData['name'] ?? 'Potion';
          ...
          return Dialog(
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  const Text("Potions", style: TextStyle(color: Colors.white, fontSize: 24)),
                  Expanded(
                    child: PageView(
                      children: allPotions.map((item) => buildItemColumn(item)).toList(),
                    ),
                  ),
                  ElevatedButton(
