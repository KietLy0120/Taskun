...
// widgets/modals/weapons_modal.dart
void showWeaponsPopup(BuildContext context, VoidCallback refreshUserData) async {
      ...
      return StatefulBuilder(
        builder: (context, setState) {
          Widget buildItemColumn(Map<String, dynamic> itemData) {
            ...
            final String name = itemData['name'] ?? 'Weapon';
          ...
          return Dialog(
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  const Text("Weapons", style: TextStyle(color: Colors.white, fontSize: 24)),
                  Expanded(
                    child: PageView(
                      children: allWeapons.map((item) => buildItemColumn(item)).toList(),
                    ),
                  ),
                  ElevatedButton(
